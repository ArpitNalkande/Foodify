...
import Foodify1 from "../assets/Foodify1.png";
        ...
        <div className="flex flex-col gap-1 lg:flex lg:justify-between lg:flex-row">
          ...
          <div className="flex gap-2 lg:gap-10 items-center">
            ...
            >
              ...
              <img
                src={Foodify1}
                style={{ marginTop: "5px", width: "150px", height: "auto" }}
                alt="Foodifyy1 Logo"
              />
            </Link>
          </div>
          ...
          <div className="flex gap-2 ">
            ...
            <Link
              to="/checkout"
              className="bg-orange-400 hover:bg-orange-500 px-5 py-1 hover:shadow-lg rounded-full flex justify-between items-center gap-3 cursor-pointer"
            >
              <div className=" flex justify-between items-center ">
                <FaShoppingCart size={25} className="mr-1" />
                <div className="flex justify-center item-center w-6 h-6 rounded-full bg-orange-600">
                  <span className="text-sm font-bold text-white">
                    {items.length > 0 ? items.length : <p></p>}
                  </span>
                </div>
              </div>
            </Link>
