    ...
    <div className="container mt-28 lg:mt-12 mx-auto p-5 ">
      <div className="px-6 lg:mx-5 lg:mt-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:justify-center lg:items-center lg:gap-10">
          <img
            className="w-48 h-48 lg:w-96 lg:h-48"
            src={foods.image}
            alt="Food item"
          ></img>
          <div>
            {foods ? (
              <div className="flex flex-col gap-4">
                ...
                <div className="">
                  Category:{" "}
                  <span className="text-orange-500">{foods.category}</span>{" "}
                </div>
                <div>
                  <h2 className="">
                    <u>Description</u>
                  ...
                  <p>
                    ...
                    Magni voluptates ea vel officiis minima dolorum quae nostrum
                    culpa? Dolores soluta facere sapiente aliquid, esse at illo
                    temporibus ea quaerat.
                  </p>
                </div>
                <div>
                  <b>Price:</b>{" "}
                  <span className="font-semibold">₹{foods.price}</span>
                </div>
                <div className="flex flex-row gap-3 justify-start items-center">
                  ...
                  {addedItem && (
                    <div className="font-bold flex items-center absolute left-40 md:left-64 lg:left-32 bg-green-500 text-white rounded p-2 transition-transform duration-300 animate-bounce">
